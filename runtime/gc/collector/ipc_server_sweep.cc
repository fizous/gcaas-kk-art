...
class ServerMarkObjectVisitor {
 public:
  ...
  void operator()(Object* /* obj */, Object* ref, MemberOffset& /* offset */,
...
IPCServerMarkerSweep::IPCServerMarkerSweep(
  ...
  spaces_[KGCSpaceServerZygoteInd_].client_end_ =
      (spaces_[KGCSpaceServerZygoteInd_].client_base_ +
          reinterpret_cast<volatile int32_t*>(&(client_rec_->pair_mapps_->first->mem_maps_[0].size_)));
  ...
  spaces_[KGCSpaceServerZygoteInd_].base_end_ =
      (spaces_[KGCSpaceServerZygoteInd_].base_ +
          reinterpret_cast<volatile int32_t*>(&(client_rec_->pair_mapps_->second->mem_maps_[0].size_)));
  ...
  spaces_[KGCSpaceServerAllocInd_].client_end_ =
      (spaces_[KGCSpaceServerAllocInd_].client_base_ +
          android_atomic_release_load(
              reinterpret_cast<volatile int32_t*>(&(client_rec_->pair_mapps_->first->mem_maps_[1].size_))));
  ...
  spaces_[KGCSpaceServerAllocInd_].base_end_ =
      (spaces_[KGCSpaceServerAllocInd_].base_ +
          reinterpret_cast<volatile int32_t*>(&(client_rec_->pair_mapps_->second->mem_maps_[1].size_)));
