...
//      CHECK_SHARED_MEMORY_CALL(mprotect, (original_end, increment, PROT_READ | PROT_WRITE), GetName());
//    } else {
...
//      CHECK_SHARED_MEMORY_CALL(madvise, (new_end, size, MADV_DONTNEED), GetName());
//      CHECK_SHARED_MEMORY_CALL(mprotect, (new_end, size, PROT_NONE), GetName());
//    }
//    // Update end_
...
//
//  SharedDlMallocSpace* _new_space = new SharedDlMallocSpace(_alloc_space,
//      _structuredMemMap, kGcRetentionPolicyAlwaysCollect, name, growth_limit,
//      initial_size, capacity, starting_size);
//  return _new_space;
//
//}
//
