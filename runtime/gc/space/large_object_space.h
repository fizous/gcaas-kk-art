...
class LargeObjectMapSpace : public LargeObjectSpace {
 ...
 private:
  ...
  typedef SafeMap<mirror::Object*, BaseMapMem*, std::less<mirror::Object*>,
      accounting::GCAllocator<std::pair<const mirror::Object*, BaseMapMem*> > > MemMaps;
...
//  size_t GetObjectSize(const mirror::Object* obj);
 ...
 private:
  ...
  FreeListSpace(const std::string& name, BaseMapMem* mem_map, byte* begin, byte* end);
  ...
  byte* GetExtraProfilerDataHeader(const mirror::Object*, size_t);
