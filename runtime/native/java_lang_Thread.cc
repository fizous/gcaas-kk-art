...
static jint Thread_nativeGetStatus(JNIEnv* env, jobject java_thread, jboolean has_been_started) {
  ...
  switch (internal_thread_state) {
    ...
    case kWaitingForGCProcess:            return kJavaWaiting;
    ...
    case kWaitingInMainGCMMPCatcherLoop:	return kJavaWaiting;
    case kWaitingForGCMMPCatcherOutput:   return kJavaWaiting;
