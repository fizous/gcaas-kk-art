...
//
//		if (!MountEmulatedStorage(_uid, MOUNT_EXTERNAL_MULTIUSER_ALL)) {
...
static jint Zygote_nativeForkAndSpecialize(JNIEnv* env, jclass, jint uid,
...
static jint Zygote_nativeForkSystemServer(JNIEnv* env, jclass, uid_t uid,
...
static JNINativeMethod gMethods[] = {
		NATIVE_METHOD(Zygote, nativeForkAndSpecialize,
				"(II[II[[IILjava/lang/String;Ljava/lang/String;)I"),
