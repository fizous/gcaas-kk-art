...
class PACKED(4) Thread {
 public:
  ...
  //ThrowLocation GetCurrentLocationForThrowNoLock();
  ...
  void ThrowNewExceptionNoLock(const ThrowLocation& throw_location,
 ...
 private:
  ...
  void Init(ThreadList*, JavaVMExt*, const char*) EXCLUSIVE_LOCKS_REQUIRED(Locks::runtime_shutdown_lock_);
  void InitCardTable();
  void InitCpu();
